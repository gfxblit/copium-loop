...
class TestPRPreChecker:
    @patch.object(pr_pre_checker_module, "validate_git_context", autospec=True)
    @patch.object(pr_pre_checker_module, "is_dirty", autospec=True)
    @patch.object(pr_pre_checker_module, "fetch", autospec=True)
    @patch.object(pr_pre_checker_module, "rebase", autospec=True)
    ...
    @patch.object(pr_pre_checker_module, "fetch", autospec=True)
    @patch.object(pr_pre_checker_module, "rebase", autospec=True)
    @patch.object(pr_pre_checker_module, "rebase_abort", autospec=True)
