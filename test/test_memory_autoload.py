...
async def test_nodes_do_not_call_get_all_memories():
    ...
    with patch("copium_loop.nodes.coder.invoke_gemini", new_callable=AsyncMock) as mock_coder_gemini:
    ...
    with patch("copium_loop.nodes.architect.invoke_gemini", new_callable=AsyncMock) as mock_arch_gemini:
    ...
    with patch("copium_loop.nodes.reviewer.invoke_gemini", new_callable=AsyncMock) as mock_rev_gemini:
