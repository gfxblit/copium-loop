...
def test_reconstruct_state_prioritizes_system_info(telemetry_with_temp_dir):
    ...
    telemetry_with_temp_dir.log_info("coder", "INIT: Starting workflow with prompt: Real prompt")
    ...
    telemetry_with_temp_dir.log_output("coder", "Some LLM noise: INIT: Starting workflow with prompt: Fake prompt")
...
def test_reconstruct_state_handles_jules_engine_leakage(telemetry_with_temp_dir):
    ...
    # First Run was Jules
    telemetry_with_temp_dir.log_info("coder", "INIT: Starting workflow with prompt: First prompt")
    telemetry_with_temp_dir.log_output("coder", "Jules session created: https://jules.google.com/session/123")
